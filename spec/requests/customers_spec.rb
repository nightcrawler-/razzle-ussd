...
RSpec.describe "/customers", type: :request do
  ...
  let(:valid_attributes) {
    { name: 'Lizzy Caplan', national_id: '29425870', phone_number: '+254723006561' }
  }

  let(:invalid_attributes) {
    { name: 'Lizzy Caplan345', national_id: '29425', phone_number: '+23006561' }
  }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      let(:new_attributes) {
        { name: 'Lizzy Caplan', national_id: '29425870', phone_number: '+254723006562' }
      }
      ...
      it "updates the requested customer" do
        ...
        customer.reload
        expect(customer.phone_number).to eq("+254723006562")
      end
